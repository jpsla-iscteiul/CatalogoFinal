<%@ Page Title="" Language="C#" MasterPageFile="~/CatalogoFinal.Master" AutoEventWireup="true" CodeBehind="contacto.aspx.cs" Inherits="ExCatalogoFinal.contacto" %>
                ...
                <div class="card-body">
                    ...
                    <div class="row w-auto mt-2">
                        ...
                        <div class="col-sm-8">
                            ...
                            <asp:RequiredFieldValidator ControlToValidate="Txt_Email" ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ValidationGroup="save"></asp:RequiredFieldValidator>
                    ...
                    <div class="row w-auto mt-2">
                        ...
                        <div class="col-sm-8">
                            <asp:Label ID="Lbl_status" runat="server" EnableViewState="false" Visible="True"></asp:Label>
                        </div>
                    </div>
